...
<body>
   <!-- 모달 팝업창 -->
        ...
        <div id="editedit${dto.review_num }" class="RE_Modal">
            <div class="RE_Modal-con">
             <form action="./reviewedit?review_num=${dto.review_num }" method="post" onsubmit="return editReviewformCheck(this)">
               ...
               <div class="RE_Likebox">
                  <div class="RE_Like_all">
                     <input type="radio" name="rating" value="good" id="ratingGood" class="rating RE_Good" ${dto.rating eq 'good' ? 'checked' : '' }> 
               ...
               <div id="RE_Miniposter" style="background-image:url(${Movie.movie_img })"></div>
               <div class="RE_Likebox">
                  <div class="RE_Like_all">
                     <input type="radio" name="rating" value="bad" id="ratingBad" class="rating RE_Bad" ${dto.rating eq 'bad' ? 'checked' : '' }> 
            ...
            <div class="RE_Star">
               <span class="RE_Star_score" id="RE_Star_score${dto.review_num }"> ★★★★★ 
                     <span id="RE_span${dto.review_num }" style="width:${dto.star_score*10 }%">★★★★★</span> 
                     <input type="range" id="editStar_score ${dto.review_num }" name="star_score" oninput="editDrawStar(this)" value="${dto.star_score}" step="1" min="0" max="10">
               </span>
            </div>
            <hr>
            <div class="RE_Alltitle">
               <img src="etc/큰 따옴표 왼쪽.png" width=35px height=35px> 
               <input id="editTitle ${dto.review_num }" class="RE_Title" name="review_title" placeholder="한줄평을 입력해주세요." type="text"  value="${dto.review_title}" autocomplete="off" maxlength="45">
               <img src="etc/큰 따옴표 오른쪽.png" width=35px height=35px><br> <br>
            </div>
            <div class="RE_Allcontent">
               <img src="etc/왼쪽 대괄호.png" height=120px>
               <textarea id="editContent ${dto.review_num }" class="RE_Content" name="review_content"
                  placeholder="영화에 대한 생각을 입력해주세요." cols="60" rows="5">${dto.review_content}</textarea>
